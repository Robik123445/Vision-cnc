...
def main() -> int:
    ...
    plane = compute_homography_px_to_mm(CLICKED_POINTS, mm_points, intrinsics=None, workspace_mm=ws, origin_mm="bottom_left", notes=args.notes, camera_id=args.camera_id)
