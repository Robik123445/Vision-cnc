...
from vision.calib.intrinsics import undistort_frame
from vision.calib.types import Intrinsics, PlaneCalibration
...
def compute_homography_px_to_mm(
    ...
    return PlaneCalibration(H_px_to_mm=H, workspace_mm=workspace_mm, origin_mm=origin_mm, notes=notes)
